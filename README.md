...
as of OTP-17 the `dict` type has moved from the `erlang` namespace to `dict`.
Using this package, you can use that type as `dict_t` regardless of the OTP
version you're building with.
